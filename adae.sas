/*
  Use metadata for imputing partial end date, as selected from your repository
...
data _null_;
INFILE metadata;
INPUT study rulename applicable_var rule_short description $ ;
IF study = "abc" AND applicable_var = "AEENDTC" THEN DO;
